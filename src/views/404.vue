    ...
    <div class="wscn-http404">
      <div class="pic-404">
        <img class="pic-404__parent"
             v-if="pageName == 'Page403'"
             src="@/assets/404_images/403.png"
             alt="403">
        <img class="pic-404__parent"
             v-else
      ...
      <div class="bullshit"
        ...
        <div class="bullshit__headline">亲，管理员说您没有权限哦！</div>
        <div class="bullshit__info">请您联系管理员配置权限，如若配置了权限，请尝试重新登录使权限生效。</div>
        <a href="javascript:;"
           @click="backHone"
      ...
      <div class="bullshit"
           v-else>
        <div class="bullshit__oops">哎呀!</div>
        <div class="bullshit__headline">亲，好像迷路了哦…</div>
